...
addQuote("Time is relative, okay? It can stretch and it can squeeze, but... it can’t run backwards. Just can’t. The only thing that can move across dimensions, like time, is gravity.", "Interstellar");
